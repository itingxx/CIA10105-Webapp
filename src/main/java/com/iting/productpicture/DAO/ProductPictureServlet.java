    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        if ("getOne_For_Display".equals(action)) { // 來自selectpage.jsp的請求
            ...
            if (!errorMsgs.isEmpty()) {// 有錯誤時將錯誤訊息傳入
                RequestDispatcher failureView = req.getRequestDispatcher("/ProductPicture/SelectPage.jsp");
            ...
            if (!errorMsgs.isEmpty()) {
                RequestDispatcher failureView = req
                        .getRequestDispatcher("/ProductPicture/SelectPage.jsp");
...
/***********************1.接收請求參數 - 輸入格式的錯誤處理*************************/
            ...
            if (!errorMsgs.isEmpty()) {
                RequestDispatcher failureView = req
                        .getRequestDispatcher("/ProductPicture/addPic.jsp");
                failureView.forward(req, res);
                return;//程式中斷
            }
            ...
            String url = "/ProductPicture/listAllPic.jsp";
        ...
        if ("update".equals(action)) { // 來自update_emp_inputproductpicture.jsp的請求
            ...
            if (!errorMsgs.isEmpty()) {
                ...
                req.setAttribute("productPictureVO", productPictureVO);
                RequestDispatcher failureView = req.getRequestDispatcher("/ProductPicture/update_productpicture.jsp");
                failureView.forward(req, res);
                return; // 程式中斷
            }
            ...
            req.setAttribute("productPictureVO", productPictureVO);
            String url = "/ProductPicture/listOnePic.jsp";
        ...
        if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
            ...
            String url = "/ProductPicture/update_productpicture.jsp";
