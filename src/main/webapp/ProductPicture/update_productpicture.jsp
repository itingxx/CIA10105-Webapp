...
<table id="table-1">
    <tr><td>
        ...
        <h4><a href="<%=request.getContextPath()%>/ProductPicture/SelectPage.jsp"><img src="../images/cat.png" width="100" height="32" border="0">回首頁</a></h4>
    </td></tr>
</table>

<h3>資料修改:</h3>
<c:if test="${not empty productPictureVO}">
<form method="post" action="productPicture.do" name="form1" enctype="multipart/form-data">
    <table>
        ...
        <tr>
            <td>商品編號:</td>
            <td><input type="text" name="pNo" value="${productPictureVO.product.pNo}" size="45"/></td>
        </tr>
        <tr>
            <td>圖片:</td>
            <td>
